...
import { initReplayMode, renderReplayStep, renderReplayUI } from './modes/replay.js';
        ...
        <div class="max-w-lg mx-auto mt-6 flex flex-col gap-6 px-2 mb-10">
            ...
            <div class="flex flex-col items-center">
                <div class="flex items-center gap-2 mb-1">
                    ...
                    <span class="bg-emerald-100 text-emerald-700 text-[10px] font-bold px-2 py-0.5 rounded-full">v1.7.4</span>
                </div>
